...
<div class="inner-block">
    <div class="inbox">
         ...
         <?php
                  ...
                  $psel = $conn->query("SELECT * FROM `post` ORDER BY Ptime DESC"); 
			...
			<table style="width: 100%; text-align: center;">
              ...
              <td>
                ...
                else
                {
                  ?>
                   <td>
                 <a href="#" style="color: red;"><i class="fa fa-save"></i></a>        
              </td>
              <?php
                }
               ?>
      ...
      <!-- link share part -->
  <!--     <div class="container darker" style="display: none;" id="tab"> 
      <center>
     <table style="width: 100%;">
      <tbody>
      <tr>
        <td>
          <textarea  rows="1" style="width: 90%; margin-left: 2em;"></textarea>
        </td>
        <td>
